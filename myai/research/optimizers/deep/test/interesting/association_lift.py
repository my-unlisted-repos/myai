...
class ALOpt(Optimizer):
    """Association Lift Optimizer. Adjusts parameter updates based on the frequency of their gradient signs relative to the global average.
    This approach amplifies updates for parameters with consistent gradient directions and dampens those with erratic behavior,
    promoting efficient convergence"""
