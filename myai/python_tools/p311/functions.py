...
P = TypeVar('P')
R = TypeVar('R')
Composable = Union[Callable[[P], R], Iterable[Callable[[P], R]]]
...
def get_full_signature(fn: Callable, *args, **kwargs) -> OrderedDict[str, Any]:
...
def get_extra_signature(fn: Callable, *args, **kwargs) -> OrderedDict[str, Any]:
    """Returns a dictionary of all keyword arguments of a function called with given args and kwargs."""
    sig = inspect.signature(fn).bind(*args, **kwargs)
    sig.apply_defaults()
...
class SaveSignature:
    def __init__(self, obj: Callable, *args, **kwargs): # pylint:disable=undefined-variable
        # self.obj: Callable[..., V] = obj # pylint:disable=undefined-variable
        self.obj: Callable = obj # pylint:disable=undefined-variable
        ...
        self.constructed_obj: _NotConstructed | Any = _NotConstructed() # pylint:disable=undefined-variable

    # def resolve(self) -> V: # pylint:disable=undefined-variable
    def resolve(self): # pylint:disable=undefined-variable
