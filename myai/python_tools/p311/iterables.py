...
def get0(x:Sequence[X]) -> X: return x[0] # pylint:disable = E0602
def get1(x:Sequence[X]) -> X: return x[1] # pylint:disable = E0602
def getlast(x:Sequence[X]) -> X: return x[-1] # pylint:disable = E0602
